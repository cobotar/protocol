...
class PartHandlingProfile(_message.Message):
    __slots__ = ("fragile", "esd_sensitive", "requires_two_hand_lift", "requires_fixture_support", "pre_lubrication_part_id", "post_lubrication_part_id", "requires_wiping", "inspect_before_assemble", "inspect_after_disassemble", "max_grip_force_n", "max_torque_nm", "constraints")
