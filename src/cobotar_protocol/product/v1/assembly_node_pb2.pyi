...
class AssemblyNode(_message.Message):
    __slots__ = ("id", "name", "parent_node_id", "kind", "part_definition_id", "override_model_id", "local_pose", "sequence_hint", "cad_occurrence_path", "join_method_hint", "insertion_offset_hint", "approach_offset_hint", "optional", "applicability")
