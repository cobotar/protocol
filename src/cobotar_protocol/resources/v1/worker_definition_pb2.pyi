...
class WorkerDefinition(_message.Message):
    __slots__ = ("id", "name", "description", "icon", "disabled", "employee_id", "ar_edit_permission", "external_references", "height", "arms_length", "handedness", "role", "preferred_interaction_side", "text_size_preference", "personal_space_radius", "handoff_height_preference", "handoff_side_preference")
