...
class AssetInstance(_message.Message):
    __slots__ = ("id", "name", "icon", "description", "asset_definition_id", "status")
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., icon: _Optional[str] = ..., description: _Optional[str] = ..., asset_definition_id: _Optional[str] = ..., status: _Optional[_Union[_enums_pb2.ResourceStatus, str]] = ...) -> None: ...
