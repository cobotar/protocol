...
class RobotInstance(_message.Message):
    __slots__ = ("id", "name", "icon", "description", "robot_definition_id", "serial_number", "mounted_tool_instance_id", "available_tool_instance_ids", "supports_tool_change", "is_simulated", "status")
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., icon: _Optional[str] = ..., description: _Optional[str] = ..., robot_definition_id: _Optional[str] = ..., serial_number: _Optional[str] = ..., mounted_tool_instance_id: _Optional[str] = ..., available_tool_instance_ids: _Optional[_Iterable[str]] = ..., supports_tool_change: bool = ..., is_simulated: bool = ..., status: _Optional[_Union[_enums_pb2.ResourceStatus, str]] = ...) -> None: ...
