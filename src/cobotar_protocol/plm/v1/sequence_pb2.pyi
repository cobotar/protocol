...
class SequenceMessage(_message.Message):
    __slots__ = ("id", "name", "icon", "description", "sequence_number", "offset", "parent_id", "sequence_ids", "task_ids", "assigned_to", "state", "completed_tasks", "can_bulk_complete")
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., icon: _Optional[str] = ..., description: _Optional[str] = ..., sequence_number: _Optional[int] = ..., offset: _Optional[_Union[_pose_pb2.Pose, _Mapping]] = ..., parent_id: _Optional[str] = ..., sequence_ids: _Optional[_Iterable[str]] = ..., task_ids: _Optional[_Iterable[str]] = ..., assigned_to: _Optional[_Iterable[str]] = ..., state: _Optional[_Union[SequenceState, str]] = ..., completed_tasks: _Optional[int] = ..., can_bulk_complete: bool = ...) -> None: ...
