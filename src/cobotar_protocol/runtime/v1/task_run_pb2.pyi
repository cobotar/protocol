...
class TaskRunState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    TASK_RUN_STATE_SUSPENDED: _ClassVar[TaskRunState]
...
class TaskRun(_message.Message):
    ...
    ACTOR_ASSIGNMENT_STATUS_FIELD_NUMBER: _ClassVar[int]
