...
class ProcessRun(_message.Message):
    __slots__ = ("id", "recipe_id", "order_id", "station_id", "cell_id", "frame", "root_sequence_run_id", "sequences", "tasks", "state", "initiated_at", "ended_at", "assignments", "variant_configuration", "parameters")
