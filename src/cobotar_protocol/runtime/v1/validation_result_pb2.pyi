...
class ValidationResult(_message.Message):
    ...
    comment: str
    def __init__(self, id: _Optional[str] = ..., task_run_id: _Optional[str] = ..., status: _Optional[_Union[ValidationStatus, str]] = ..., method: _Optional[str] = ..., validated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., measurements: _Optional[_Iterable[_Union[_key_value_constraint_pb2.KeyValueConstraint, _Mapping]]] = ..., validated_by_actor_id: _Optional[str] = ..., comment: _Optional[str] = ...) -> None: ...
