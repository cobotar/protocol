...
class ValidationResult(_message.Message):
    __slots__ = ("id", "task_run_id", "status", "method", "validated_at", "measurements", "validated_by_actor_id", "comment")
    ...
    VALIDATED_BY_ACTOR_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    measurements: _containers.RepeatedCompositeFieldContainer[_common_pb2.KeyValueConstraint]
    validated_by_actor_id: str
    comment: str
    def __init__(self, id: _Optional[str] = ..., task_run_id: _Optional[str] = ..., status: _Optional[_Union[ValidationStatus, str]] = ..., method: _Optional[str] = ..., validated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., measurements: _Optional[_Iterable[_Union[_common_pb2.KeyValueConstraint, _Mapping]]] = ..., validated_by_actor_id: _Optional[str] = ..., comment: _Optional[str] = ...) -> None: ...
