...
class ModelArtifact(_message.Message):
    __slots__ = ("id", "name", "description", "icon", "group", "origin", "format", "filename", "uri", "thumbnail_uri", "version", "unit", "up_axis", "external_references", "custom")
