...
class StationDefinition(_message.Message):
    __slots__ = ("id", "name", "description", "icon", "tool_instance_ids", "fixture_instance_ids", "robot_instance_ids", "asset_instance_ids", "frame", "custom")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ICON_FIELD_NUMBER: _ClassVar[int]
    TOOL_INSTANCE_IDS_FIELD_NUMBER: _ClassVar[int]
    FIXTURE_INSTANCE_IDS_FIELD_NUMBER: _ClassVar[int]
    ...
    fixture_instance_ids: _containers.RepeatedScalarFieldContainer[str]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., icon: _Optional[str] = ..., tool_instance_ids: _Optional[_Iterable[str]] = ..., fixture_instance_ids: _Optional[_Iterable[str]] = ..., robot_instance_ids: _Optional[_Iterable[str]] = ..., asset_instance_ids: _Optional[_Iterable[str]] = ..., frame: _Optional[_Union[_pose_pb2.LocalizedPose, _Mapping]] = ..., custom: _Optional[_Union[_common_pb2.CustomProperties, _Mapping]] = ...) -> None: ...
