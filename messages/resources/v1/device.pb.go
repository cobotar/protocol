...
func (DeviceType) Descriptor() protoreflect.EnumDescriptor {
	return file_resources_v1_device_proto_enumTypes[0].Descriptor()
}

func (DeviceType) Type() protoreflect.EnumType {
	return &file_resources_v1_device_proto_enumTypes[0]
}
...
func (DeviceType) EnumDescriptor() ([]byte, []int) {
	return file_resources_v1_device_proto_rawDescGZIP(), []int{0}
}
...
func (DeviceStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_resources_v1_device_proto_enumTypes[1].Descriptor()
}

func (DeviceStatus) Type() protoreflect.EnumType {
	return &file_resources_v1_device_proto_enumTypes[1]
}
...
func (DeviceStatus) EnumDescriptor() ([]byte, []int) {
	return file_resources_v1_device_proto_rawDescGZIP(), []int{1}
}
...
func (DeviceBatteryStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_resources_v1_device_proto_enumTypes[2].Descriptor()
}

func (DeviceBatteryStatus) Type() protoreflect.EnumType {
	return &file_resources_v1_device_proto_enumTypes[2]
}
...
func (x *DeviceMessage) Reset() {
	*x = DeviceMessage{}
	mi := &file_resources_v1_device_proto_msgTypes[0]
...
func (x *DeviceMessages) Reset() {
	*x = DeviceMessages{}
	mi := &file_resources_v1_device_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DeviceHeartbeat) Reset() {
	*x = DeviceHeartbeat{}
	mi := &file_resources_v1_device_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_resources_v1_device_proto protoreflect.FileDescriptor
...
const file_resources_v1_device_proto_rawDesc = "" +
	...
	"\x1aDEVICE_BATTERY_STATUS_FULL\x10\x04B\xb8\x01\n" +
	"\x10com.resources.v1B\vDeviceProtoP\x01Z=github.com/cobotar/protocol/messages/resources/v1;resourcesv1\xa2\x02\x03RXX\xaa\x02\x15Messages.Resources.V1\xca\x02\fResources\\V1\xe2\x02\x18Resources\\V1\\GPBMetadata\xea\x02\rResources::V1b\x06proto3"

var (
	file_resources_v1_device_proto_rawDescOnce sync.Once
	file_resources_v1_device_proto_rawDescData []byte
)

func file_resources_v1_device_proto_rawDescGZIP() []byte {
	file_resources_v1_device_proto_rawDescOnce.Do(func() {
		file_resources_v1_device_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_v1_device_proto_rawDesc), len(file_resources_v1_device_proto_rawDesc)))
	})
	return file_resources_v1_device_proto_rawDescData
}

var file_resources_v1_device_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_resources_v1_device_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_resources_v1_device_proto_goTypes = []any{
	(DeviceType)(0),          // 0: resources.v1.DeviceType
	(DeviceStatus)(0),        // 1: resources.v1.DeviceStatus
	(DeviceBatteryStatus)(0), // 2: resources.v1.DeviceBatteryStatus
	(*DeviceMessage)(nil),    // 3: resources.v1.DeviceMessage
	(*DeviceMessages)(nil),   // 4: resources.v1.DeviceMessages
	(*DeviceHeartbeat)(nil),  // 5: resources.v1.DeviceHeartbeat
}
var file_resources_v1_device_proto_depIdxs = []int32{
	0, // 0: resources.v1.DeviceMessage.type:type_name -> resources.v1.DeviceType
	1, // 1: resources.v1.DeviceMessage.status:type_name -> resources.v1.DeviceStatus
	2, // 2: resources.v1.DeviceMessage.battery_status:type_name -> resources.v1.DeviceBatteryStatus
	3, // 3: resources.v1.DeviceMessages.devices:type_name -> resources.v1.DeviceMessage
	2, // 4: resources.v1.DeviceHeartbeat.battery_status:type_name -> resources.v1.DeviceBatteryStatus
...
func init() { file_resources_v1_device_proto_init() }
func file_resources_v1_device_proto_init() {
	if File_resources_v1_device_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_v1_device_proto_rawDesc), len(file_resources_v1_device_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_v1_device_proto_goTypes,
		DependencyIndexes: file_resources_v1_device_proto_depIdxs,
		EnumInfos:         file_resources_v1_device_proto_enumTypes,
		MessageInfos:      file_resources_v1_device_proto_msgTypes,
	}.Build()
	File_resources_v1_device_proto = out.File
	file_resources_v1_device_proto_goTypes = nil
	file_resources_v1_device_proto_depIdxs = nil
}
