...
var (
	SkillInvalidityReason_name = map[int32]string{
		0: "SKILL_INVALIDITY_REASON_UNSPECIFIED",
		1: "SKILL_INVALIDITY_REASON_INACTIVITY",
		2: "SKILL_INVALIDITY_REASON_FAILURE_RATE",
		3: "SKILL_INVALIDITY_REASON_POLICY_EXPIRED",
		4: "SKILL_INVALIDITY_REASON_ENGINEERING_CHANGE",
	}
