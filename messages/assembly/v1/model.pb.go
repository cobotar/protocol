...
func (ModelGroup) Descriptor() protoreflect.EnumDescriptor {
	return file_assembly_v1_model_proto_enumTypes[0].Descriptor()
}

func (ModelGroup) Type() protoreflect.EnumType {
	return &file_assembly_v1_model_proto_enumTypes[0]
}
...
func (ModelGroup) EnumDescriptor() ([]byte, []int) {
	return file_assembly_v1_model_proto_rawDescGZIP(), []int{0}
}
...
func (ModelOrigin) Descriptor() protoreflect.EnumDescriptor {
	return file_assembly_v1_model_proto_enumTypes[1].Descriptor()
}

func (ModelOrigin) Type() protoreflect.EnumType {
	return &file_assembly_v1_model_proto_enumTypes[1]
}
...
func (ModelOrigin) EnumDescriptor() ([]byte, []int) {
	return file_assembly_v1_model_proto_rawDescGZIP(), []int{1}
}
...
func (ModelFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_assembly_v1_model_proto_enumTypes[2].Descriptor()
}

func (ModelFormat) Type() protoreflect.EnumType {
	return &file_assembly_v1_model_proto_enumTypes[2]
}
...
func (ModelFormat) EnumDescriptor() ([]byte, []int) {
	return file_assembly_v1_model_proto_rawDescGZIP(), []int{2}
}
...
func (x *ModelArtifact) Reset() {
	*x = ModelArtifact{}
	mi := &file_assembly_v1_model_proto_msgTypes[0]
...
func (x *ModelArtifact) GetCustom() *CustomProperties {
	if x != nil {
		return x.Custom
	}
	return nil
...
func (x *ModelArtifacts) Reset() {
	*x = ModelArtifacts{}
	mi := &file_assembly_v1_model_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_assembly_v1_model_proto protoreflect.FileDescriptor
...
const file_assembly_v1_model_proto_rawDesc = "" +
	...
	"\x11MODEL_FORMAT_USDZ\x10\x06B\xb0\x01\n" +
	"\x0fcom.assembly.v1B\n" +
	"ModelProtoP\x01Z;github.com/cobotar/protocol/messages/assembly/v1;assemblyv1\xa2\x02\x03AXX\xaa\x02\x14Messages.Assembly.V1\xca\x02\vAssembly\\V1\xe2\x02\x17Assembly\\V1\\GPBMetadata\xea\x02\fAssembly::V1b\x06proto3"

var (
	file_assembly_v1_model_proto_rawDescOnce sync.Once
	file_assembly_v1_model_proto_rawDescData []byte
)

func file_assembly_v1_model_proto_rawDescGZIP() []byte {
	file_assembly_v1_model_proto_rawDescOnce.Do(func() {
		file_assembly_v1_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_assembly_v1_model_proto_rawDesc), len(file_assembly_v1_model_proto_rawDesc)))
	})
	return file_assembly_v1_model_proto_rawDescData
}

var file_assembly_v1_model_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_assembly_v1_model_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_assembly_v1_model_proto_goTypes = []any{
	(ModelGroup)(0),           // 0: assembly.v1.ModelGroup
	(ModelOrigin)(0),          // 1: assembly.v1.ModelOrigin
	(ModelFormat)(0),          // 2: assembly.v1.ModelFormat
	(*ModelArtifact)(nil),     // 3: assembly.v1.ModelArtifact
	(*ModelArtifacts)(nil),    // 4: assembly.v1.ModelArtifacts
	(*ExternalReference)(nil), // 5: assembly.v1.ExternalReference
	(*CustomProperties)(nil),  // 6: assembly.v1.CustomProperties
}
var file_assembly_v1_model_proto_depIdxs = []int32{
	0, // 0: assembly.v1.ModelArtifact.group:type_name -> assembly.v1.ModelGroup
	1, // 1: assembly.v1.ModelArtifact.origin:type_name -> assembly.v1.ModelOrigin
	2, // 2: assembly.v1.ModelArtifact.format:type_name -> assembly.v1.ModelFormat
	5, // 3: assembly.v1.ModelArtifact.external_references:type_name -> assembly.v1.ExternalReference
	6, // 4: assembly.v1.ModelArtifact.custom:type_name -> assembly.v1.CustomProperties
	3, // 5: assembly.v1.ModelArtifacts.items:type_name -> assembly.v1.ModelArtifact
...
func init() { file_assembly_v1_model_proto_init() }
func file_assembly_v1_model_proto_init() {
	if File_assembly_v1_model_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_assembly_v1_model_proto_rawDesc), len(file_assembly_v1_model_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_assembly_v1_model_proto_goTypes,
		DependencyIndexes: file_assembly_v1_model_proto_depIdxs,
		EnumInfos:         file_assembly_v1_model_proto_enumTypes,
		MessageInfos:      file_assembly_v1_model_proto_msgTypes,
	}.Build()
	File_assembly_v1_model_proto = out.File
	file_assembly_v1_model_proto_goTypes = nil
	file_assembly_v1_model_proto_depIdxs = nil
}
