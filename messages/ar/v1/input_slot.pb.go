...
const file_ar_v1_input_slot_proto_rawDesc = "" +
	"\n" +
	"\x16ar/v1/input_slot.proto\x12\x05ar.v1\x1a\x1bbuf/validate/validate.proto\x1a+validation/v1/predefined_string_rules.proto\"\xd8\x04\n" +
	...
	"\rresource_type\x18\b \x01(\x0e2\x19.ar.v1.ARResourceSlotTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\fresourceType\x12E\n" +
	"\fcontext_type\x18\t \x01(\x0e2\x18.ar.v1.ARContextSlotTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\vcontextType:\xbb\x01\xbaH\xb7\x01\x1a\xb4\x01\n" +
	"'ar_input_slot_add.exactly_one_slot_kind\x12Rexactly one of resource_type or context_type must be specified and non-UNSPECIFIED\x1a5(this.resource_type != 0) != (this.context_type != 0)\"\xb8\x01\n" +
