...
/**
 * @generated from message product.v1.PartInstances
 */
export type PartInstances = Message<"product.v1.PartInstances"> & {
  /**
   * @generated from field: repeated product.v1.PartInstance items = 1;
   */
  items: PartInstance[];
};

/**
 * Describes the message product.v1.PartInstances.
 * Use `create(PartInstancesSchema)` to create a new message.
 */
export const PartInstancesSchema: GenMessage<PartInstances> = /*@__PURE__*/
  messageDesc(file_product_v1_part_instance, 3);
