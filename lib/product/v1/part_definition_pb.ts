...
export type PartHandlingProfile = Message<"product.v1.PartHandlingProfile"> & {
   ...
   *
   * @generated from field: double default_grip_force_n = 6;
   */
  defaultGripForceN: number;

  /**
   * Maximum gripping/clamping force that may be applied without damaging the part.
   *
   * @generated from field: double max_grip_force_n = 7;
   */
   ...
   *
   * @generated from field: double default_torque_nm = 8;
   */
  defaultTorqueNm: number;
