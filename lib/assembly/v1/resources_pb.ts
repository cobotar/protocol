...
export type RobotDefinition = Message<"assembly.v1.RobotDefinition"> & {
  ...
  /**
   * @generated from field: string end_effector_tool_definition_id = 8;
   */
  endEffectorToolDefinitionId: string;
  ...
  /**
   * @generated from field: assembly.v1.CapabilityProfile capability_profile = 10;
   */
  capabilityProfile?: CapabilityProfile;

  /**
   * @generated from field: assembly.v1.CustomProperties custom = 11;
   */
  custom?: CustomProperties;
};
...
export type RobotInstance = Message<"assembly.v1.RobotInstance"> & {
  ...
  /**
   * @generated from field: geometry.v1.LocalizedPose base_pose = 5;
   */
